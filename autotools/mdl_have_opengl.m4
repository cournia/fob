...
dnl
dnl @version 0.01 $Id: mdl_have_opengl.m4,v 1.1 2003/07/25 01:02:14 cournia Exp $
...
dnl cournia 20021126 - this doesn't work with the new autoconf, i've updated it below
...
dnl       AC_ARG_ENABLE(Mesa, [mother fucker], use_Mesa=$enableval, use_Mesa=yes)
